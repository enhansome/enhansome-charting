...
*Inspired by the [Awesome](https://github.com/sindresorhus/awesome) ⭐ 504,437 | 🐛 106 | 📅 2026-09-02 thing.*
...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 504,437 | 🐛 106 | 📅 2026-09-02 [![Build Status](https://travis-ci.org/zingchart/awesome-charting.svg?branch=master)](https://travis-ci.org/zingchart/awesome-charting)
...
* [ECharts](https://github.com/ecomfe/echarts) ⭐ 67,278 | 🐛 1,510 | 🌐 TypeScript | 📅 2026-09-04 - A powerful charting and visualization library for browser.
* [Plotly](https://github.com/plotly/plotly.js) ⭐ 18,320 | 🐛 770 | 🌐 JavaScript | 📅 2026-09-09 - Built on top of d3 and stack.gl, allowing users to create basic charts and SVG maps.
* [lightweight-charts](https://github.com/tradingview/lightweight-charts) ⭐ 17,216 | 🐛 135 | 🌐 TypeScript | 📅 2026-09-09 - Financial lightweight charts built with HTML5 canvas
* [apexcharts.js](https://github.com/apexcharts/apexcharts.js) ⭐ 15,151 | 🐛 309 | 🌐 JavaScript | 📅 2026-09-09 - A JavaScript Chart Library with simple API.
* [sigma.js](https://github.com/jacomyal/sigma.js) ⭐ 12,160 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-20 - Graphs / Network diagram library built with canvas.
* [μPlot](https://github.com/leeoniya/uPlot) ⭐ 10,479 | 🐛 149 | 🌐 JavaScript | 📅 2026-09-09 - A small (< 25 KB min), fast chart for time series, lines, areas, ohlc & bars.
* [Chartkick](https://github.com/ankane/chartkick) ⭐ 6,530 | 🐛 7 | 🌐 Ruby | 📅 2026-08-15 - JavaScript charts with one line of Ruby.
* [dygraphs](https://github.com/danvk/dygraphs) ⭐ 3,239 | 🐛 264 | 🌐 JavaScript | 📅 2026-07-29 - Interactive zoomable time series charts.
* [Plottable](https://github.com/palantir/plottable) ⭐ 3,115 | 🐛 330 | 🌐 TypeScript | 📅 2025-09-08 - Library with OOP style syntax to build charts.
* [Smoothie Charts](https://github.com/joewalnes/smoothie) ⭐ 2,278 | 🐛 28 | 🌐 JavaScript | 📅 2023-01-08 - JavaScript charts for realtime streaming data.
* [QuickChart](https://github.com/typpo/quickchart) ⭐ 2,055 | 🐛 43 | 🌐 JavaScript | 📅 2024-09-21 - Web API that renders static chart images.
...
* [nivo](https://github.com/plouc/nivo) ⭐ 14,090 | 🐛 50 | 🌐 TypeScript | 📅 2026-07-21 - React components to easily build dataviz apps, built on top of D3.
...
* [react-vis](https://github.com/uber/react-vis) ⭐ 8,784 | 🐛 343 | 🌐 JavaScript | 📅 2024-12-18 - a composable visualization system by Uber
* [react-vis](https://github.com/uber-common/react-vis) ⭐ 8,784 | 🐛 343 | 🌐 JavaScript | 📅 2024-12-18 - A collection of React components to render common data visualization charts
* [react-chart-js](https://github.com/jerairrest/react-chartjs-2) ⭐ 6,941 | 🐛 111 | 🌐 TypeScript | 📅 2026-09-09 - React wrapper for Chart.js
