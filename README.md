...
*Inspired by the [Awesome](https://github.com/sindresorhus/awesome) ⭐ 507,022 | 🐛 106 | 📅 2026-09-02 thing.*
...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 507,022 | 🐛 106 | 📅 2026-09-02 [![Build Status](https://travis-ci.org/zingchart/awesome-charting.svg?branch=master)](https://travis-ci.org/zingchart/awesome-charting)
...
* [ECharts](https://github.com/ecomfe/echarts) ⭐ 67,344 | 🐛 1,505 | 🌐 TypeScript | 📅 2026-09-16 - A powerful charting and visualization library for browser.
* [Plotly](https://github.com/plotly/plotly.js) ⭐ 18,336 | 🐛 775 | 🌐 JavaScript | 📅 2026-09-16 - Built on top of d3 and stack.gl, allowing users to create basic charts and SVG maps.
* [lightweight-charts](https://github.com/tradingview/lightweight-charts) ⭐ 17,290 | 🐛 129 | 🌐 TypeScript | 📅 2026-09-16 - Financial lightweight charts built with HTML5 canvas
...
* [sigma.js](https://github.com/jacomyal/sigma.js) ⭐ 12,167 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-16 - Graphs / Network diagram library built with canvas.
* [μPlot](https://github.com/leeoniya/uPlot) ⭐ 10,496 | 🐛 144 | 🌐 JavaScript | 📅 2026-09-17 - A small (< 25 KB min), fast chart for time series, lines, areas, ohlc & bars.
...
* [Plottable](https://github.com/palantir/plottable) ⭐ 3,119 | 🐛 332 | 🌐 TypeScript | 📅 2025-09-08 - Library with OOP style syntax to build charts.
...
* [nivo](https://github.com/plouc/nivo) ⭐ 14,098 | 🐛 50 | 🌐 TypeScript | 📅 2026-07-21 - React components to easily build dataviz apps, built on top of D3.
...
* [react-chart-js](https://github.com/jerairrest/react-chartjs-2) ⭐ 6,940 | 🐛 111 | 🌐 TypeScript | 📅 2026-09-16 - React wrapper for Chart.js
