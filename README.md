...
*Inspired by the [Awesome](https://github.com/sindresorhus/awesome) ⭐ 502,600 | 🐛 105 | 📅 2026-09-02 thing.*
...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 502,600 | 🐛 105 | 📅 2026-09-02 [![Build Status](https://travis-ci.org/zingchart/awesome-charting.svg?branch=master)](https://travis-ci.org/zingchart/awesome-charting)
...
* [ECharts](https://github.com/ecomfe/echarts) ⭐ 67,226 | 🐛 1,526 | 🌐 TypeScript | 📅 2026-09-03 - A powerful charting and visualization library for browser.
* [Plotly](https://github.com/plotly/plotly.js) ⭐ 18,316 | 🐛 773 | 🌐 JavaScript | 📅 2026-09-03 - Built on top of d3 and stack.gl, allowing users to create basic charts and SVG maps.
* [lightweight-charts](https://github.com/tradingview/lightweight-charts) ⭐ 17,161 | 🐛 126 | 🌐 TypeScript | 📅 2026-09-03 - Financial lightweight charts built with HTML5 canvas
* [apexcharts.js](https://github.com/apexcharts/apexcharts.js) ⭐ 15,145 | 🐛 312 | 🌐 JavaScript | 📅 2026-09-03 - A JavaScript Chart Library with simple API.
...
* [μPlot](https://github.com/leeoniya/uPlot) ⭐ 10,468 | 🐛 149 | 🌐 JavaScript | 📅 2026-04-22 - A small (< 25 KB min), fast chart for time series, lines, areas, ohlc & bars.
...
* [react-chart-js](https://github.com/jerairrest/react-chartjs-2) ⭐ 6,943 | 🐛 108 | 🌐 TypeScript | 📅 2026-08-26 - React wrapper for Chart.js
