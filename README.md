...
*Inspired by the [Awesome](https://github.com/sindresorhus/awesome) ⭐ 501,932 | 🐛 105 | 📅 2026-08-21 thing.*
...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 501,932 | 🐛 105 | 📅 2026-08-21 [![Build Status](https://travis-ci.org/zingchart/awesome-charting.svg?branch=master)](https://travis-ci.org/zingchart/awesome-charting)
...
* [ECharts](https://github.com/ecomfe/echarts) ⭐ 67,209 | 🐛 1,522 | 🌐 TypeScript | 📅 2026-08-04 - A powerful charting and visualization library for browser.
* [Plotly](https://github.com/plotly/plotly.js) ⭐ 18,312 | 🐛 767 | 🌐 JavaScript | 📅 2026-09-01 - Built on top of d3 and stack.gl, allowing users to create basic charts and SVG maps.
* [lightweight-charts](https://github.com/tradingview/lightweight-charts) ⭐ 17,152 | 🐛 127 | 🌐 TypeScript | 📅 2026-09-01 - Financial lightweight charts built with HTML5 canvas
* [apexcharts.js](https://github.com/apexcharts/apexcharts.js) ⭐ 15,146 | 🐛 309 | 🌐 JavaScript | 📅 2026-08-31 - A JavaScript Chart Library with simple API.
* [sigma.js](https://github.com/jacomyal/sigma.js) ⭐ 12,156 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-20 - Graphs / Network diagram library built with canvas.
* [μPlot](https://github.com/leeoniya/uPlot) ⭐ 10,462 | 🐛 149 | 🌐 JavaScript | 📅 2026-04-22 - A small (< 25 KB min), fast chart for time series, lines, areas, ohlc & bars.
* [Chartkick](https://github.com/ankane/chartkick) ⭐ 6,527 | 🐛 7 | 🌐 Ruby | 📅 2026-08-15 - JavaScript charts with one line of Ruby.
* [dygraphs](https://github.com/danvk/dygraphs) ⭐ 3,239 | 🐛 264 | 🌐 JavaScript | 📅 2026-07-29 - Interactive zoomable time series charts.
* [Plottable](https://github.com/palantir/plottable) ⭐ 3,112 | 🐛 330 | 🌐 TypeScript | 📅 2025-09-08 - Library with OOP style syntax to build charts.
