...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 497,998 | 🐛 105 | 📅 2026-08-18 [![Build Status](https://travis-ci.org/zingchart/awesome-charting.svg?branch=master)](https://travis-ci.org/zingchart/awesome-charting)
...
* [ECharts](https://github.com/ecomfe/echarts) ⭐ 67,100 | 🐛 1,556 | 🌐 TypeScript | 📅 2026-08-04 - A powerful charting and visualization library for browser.
* [Plotly](https://github.com/plotly/plotly.js) ⭐ 18,296 | 🐛 846 | 🌐 JavaScript | 📅 2026-08-19 - Built on top of d3 and stack.gl, allowing users to create basic charts and SVG maps.
* [lightweight-charts](https://github.com/tradingview/lightweight-charts) ⭐ 17,005 | 🐛 126 | 🌐 TypeScript | 📅 2026-08-12 - Financial lightweight charts built with HTML5 canvas
...
* [μPlot](https://github.com/leeoniya/uPlot) ⭐ 10,427 | 🐛 150 | 🌐 JavaScript | 📅 2026-04-22 - A small (< 25 KB min), fast chart for time series, lines, areas, ohlc & bars.
...
* [QuickChart](https://github.com/typpo/quickchart) ⭐ 2,051 | 🐛 43 | 🌐 JavaScript | 📅 2024-09-21 - Web API that renders static chart images.
...
* [nivo](https://github.com/plouc/nivo) ⭐ 14,084 | 🐛 49 | 🌐 TypeScript | 📅 2026-07-21 - React components to easily build dataviz apps, built on top of D3.
...
* [react-chart-js](https://github.com/jerairrest/react-chartjs-2) ⭐ 6,941 | 🐛 107 | 🌐 TypeScript | 📅 2026-08-14 - React wrapper for Chart.js
