...
*Inspired by the [Awesome](https://github.com/sindresorhus/awesome) ⭐ 500,485 | 🐛 105 | 📅 2026-08-21 thing.*
...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 500,485 | 🐛 105 | 📅 2026-08-21 [![Build Status](https://travis-ci.org/zingchart/awesome-charting.svg?branch=master)](https://travis-ci.org/zingchart/awesome-charting)
...
* [ECharts](https://github.com/ecomfe/echarts) ⭐ 67,165 | 🐛 1,537 | 🌐 TypeScript | 📅 2026-08-04 - A powerful charting and visualization library for browser.
* [Plotly](https://github.com/plotly/plotly.js) ⭐ 18,302 | 🐛 822 | 🌐 JavaScript | 📅 2026-08-27 - Built on top of d3 and stack.gl, allowing users to create basic charts and SVG maps.
* [lightweight-charts](https://github.com/tradingview/lightweight-charts) ⭐ 17,095 | 🐛 126 | 🌐 TypeScript | 📅 2026-08-21 - Financial lightweight charts built with HTML5 canvas
* [apexcharts.js](https://github.com/apexcharts/apexcharts.js) ⭐ 15,139 | 🐛 309 | 🌐 JavaScript | 📅 2026-08-27 - A JavaScript Chart Library with simple API.
* [sigma.js](https://github.com/jacomyal/sigma.js) ⭐ 12,147 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-20 - Graphs / Network diagram library built with canvas.
* [μPlot](https://github.com/leeoniya/uPlot) ⭐ 10,454 | 🐛 149 | 🌐 JavaScript | 📅 2026-04-22 - A small (< 25 KB min), fast chart for time series, lines, areas, ohlc & bars.
* [Chartkick](https://github.com/ankane/chartkick) ⭐ 6,528 | 🐛 7 | 🌐 Ruby | 📅 2026-08-15 - JavaScript charts with one line of Ruby.
* [dygraphs](https://github.com/danvk/dygraphs) ⭐ 3,240 | 🐛 264 | 🌐 JavaScript | 📅 2026-07-29 - Interactive zoomable time series charts.
* [Plottable](https://github.com/palantir/plottable) ⭐ 3,110 | 🐛 330 | 🌐 TypeScript | 📅 2025-09-08 - Library with OOP style syntax to build charts.
...
* [QuickChart](https://github.com/typpo/quickchart) ⭐ 2,053 | 🐛 43 | 🌐 JavaScript | 📅 2024-09-21 - Web API that renders static chart images.
...
* [n3-charts](https://github.com/n3-charts/line-chart) ⭐ 1,196 | 🐛 53 | 🌐 TypeScript | 📅 2022-03-01 - Easy to use library written with AngularJS, rendering charts with D3.
...
* [lit-line](https://github.com/apinet/lit-line) ⭐ 22 | 🐛 1 | 🌐 TypeScript | 📅 2024-12-18 - {fast, small, interactive, fully responsive} Line Chart web component build on top of lit-html.

### React

* [nivo](https://github.com/plouc/nivo) ⭐ 14,092 | 🐛 50 | 🌐 TypeScript | 📅 2026-07-21 - React components to easily build dataviz apps, built on top of D3.
* [Victory](https://github.com/FormidableLabs/victory) ⭐ 11,242 | 🐛 91 | 🌐 TypeScript | 📅 2025-12-19 - A collection of composable React components for building interactive data visualizations
* [react-vis](https://github.com/uber/react-vis) ⭐ 8,789 | 🐛 343 | 🌐 JavaScript | 📅 2024-12-18 - a composable visualization system by Uber
* [react-vis](https://github.com/uber-common/react-vis) ⭐ 8,789 | 🐛 343 | 🌐 JavaScript | 📅 2024-12-18 - A collection of React components to render common data visualization charts
* [react-chart-js](https://github.com/jerairrest/react-chartjs-2) ⭐ 6,939 | 🐛 108 | 🌐 TypeScript | 📅 2026-08-26 - React wrapper for Chart.js
