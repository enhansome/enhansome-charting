...
*Inspired by the [Awesome](https://github.com/sindresorhus/awesome) ⭐ 506,239 | 🐛 106 | 📅 2026-09-02 thing.*
...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 506,239 | 🐛 106 | 📅 2026-09-02 [![Build Status](https://travis-ci.org/zingchart/awesome-charting.svg?branch=master)](https://travis-ci.org/zingchart/awesome-charting)
...
* [ECharts](https://github.com/ecomfe/echarts) ⭐ 67,327 | 🐛 1,501 | 🌐 TypeScript | 📅 2026-09-14 - A powerful charting and visualization library for browser.
* [Plotly](https://github.com/plotly/plotly.js) ⭐ 18,333 | 🐛 770 | 🌐 JavaScript | 📅 2026-09-14 - Built on top of d3 and stack.gl, allowing users to create basic charts and SVG maps.
* [lightweight-charts](https://github.com/tradingview/lightweight-charts) ⭐ 17,272 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-10 - Financial lightweight charts built with HTML5 canvas
* [apexcharts.js](https://github.com/apexcharts/apexcharts.js) ⭐ 15,157 | 🐛 301 | 🌐 JavaScript | 📅 2026-09-15 - A JavaScript Chart Library with simple API.
* [sigma.js](https://github.com/jacomyal/sigma.js) ⭐ 12,164 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-14 - Graphs / Network diagram library built with canvas.
* [μPlot](https://github.com/leeoniya/uPlot) ⭐ 10,493 | 🐛 147 | 🌐 JavaScript | 📅 2026-09-15 - A small (< 25 KB min), fast chart for time series, lines, areas, ohlc & bars.
* [Chartkick](https://github.com/ankane/chartkick) ⭐ 6,531 | 🐛 7 | 🌐 Ruby | 📅 2026-08-15 - JavaScript charts with one line of Ruby.
