...
*Inspired by the [Awesome](https://github.com/sindresorhus/awesome) ⭐ 505,316 | 🐛 106 | 📅 2026-09-02 thing.*
...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 505,316 | 🐛 106 | 📅 2026-09-02 [![Build Status](https://travis-ci.org/zingchart/awesome-charting.svg?branch=master)](https://travis-ci.org/zingchart/awesome-charting)
...
* [ECharts](https://github.com/ecomfe/echarts) ⭐ 67,305 | 🐛 1,506 | 🌐 TypeScript | 📅 2026-09-12 - A powerful charting and visualization library for browser.
* [Plotly](https://github.com/plotly/plotly.js) ⭐ 18,327 | 🐛 773 | 🌐 JavaScript | 📅 2026-09-11 - Built on top of d3 and stack.gl, allowing users to create basic charts and SVG maps.
* [lightweight-charts](https://github.com/tradingview/lightweight-charts) ⭐ 17,243 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-10 - Financial lightweight charts built with HTML5 canvas
* [apexcharts.js](https://github.com/apexcharts/apexcharts.js) ⭐ 15,154 | 🐛 311 | 🌐 JavaScript | 📅 2026-09-12 - A JavaScript Chart Library with simple API.
* [sigma.js](https://github.com/jacomyal/sigma.js) ⭐ 12,163 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-20 - Graphs / Network diagram library built with canvas.
...
* [nivo](https://github.com/plouc/nivo) ⭐ 14,094 | 🐛 50 | 🌐 TypeScript | 📅 2026-07-21 - React components to easily build dataviz apps, built on top of D3.
