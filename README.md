...
*Inspired by the [Awesome](https://github.com/sindresorhus/awesome) ⭐ 506,598 | 🐛 106 | 📅 2026-09-02 thing.*
...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 506,598 | 🐛 106 | 📅 2026-09-02 [![Build Status](https://travis-ci.org/zingchart/awesome-charting.svg?branch=master)](https://travis-ci.org/zingchart/awesome-charting)
...
* [ECharts](https://github.com/ecomfe/echarts) ⭐ 67,335 | 🐛 1,502 | 🌐 TypeScript | 📅 2026-09-16 - A powerful charting and visualization library for browser.
* [Plotly](https://github.com/plotly/plotly.js) ⭐ 18,334 | 🐛 773 | 🌐 JavaScript | 📅 2026-09-16 - Built on top of d3 and stack.gl, allowing users to create basic charts and SVG maps.
* [lightweight-charts](https://github.com/tradingview/lightweight-charts) ⭐ 17,281 | 🐛 129 | 🌐 TypeScript | 📅 2026-09-16 - Financial lightweight charts built with HTML5 canvas
...
* [sigma.js](https://github.com/jacomyal/sigma.js) ⭐ 12,165 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-16 - Graphs / Network diagram library built with canvas.
...
* [react-chart-js](https://github.com/jerairrest/react-chartjs-2) ⭐ 6,939 | 🐛 111 | 🌐 TypeScript | 📅 2026-09-16 - React wrapper for Chart.js
